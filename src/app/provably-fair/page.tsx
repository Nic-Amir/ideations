...
// Last digit extracted: 7`}</pre>
      ...
      <section className="space-y-4">
        ...
        <p className="body-sm text-on-subtle leading-relaxed">
          A momentum game built directly on Deriv Crash synthetic indices
          (Crash 50, 150, 300). A Crash N index ascends and corrects on average
          once every N ticks — the correction is generated by Deriv&apos;s
          audited market engine, not by this game. A correction is detected as
          any downward move in the quote, since the index only rises between
          correction events.
        </p>
        <p className="body-sm text-on-subtle leading-relaxed">
